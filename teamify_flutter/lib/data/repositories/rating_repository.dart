...
class RatingRepository {
  ...
  Future<List<Map<String, dynamic>>> getUserRatings(String userId) async {
    final response =
        await _client.get<dynamic>('/api/ratings/user/$userId');
  ...
  Future<double> getUserAverageRating(String userId) async {
    final response =
        await _client.get<Map<String, dynamic>>('/api/ratings/user/$userId/avg');
  ...
  Future<void> updateRating(
      String id, double score, String comment) async {
