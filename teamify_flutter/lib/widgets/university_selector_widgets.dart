...
class _UniversitySearchBottomSheetState
  ...
  final DemoUniversityStore _store = DemoUniversityStore.instance;
  ...
  List<UniversityOption> get _filteredUniversities {
    ...
    final all = _store.allUniversities;
    ...
    final otherOption = all.firstWhere((u) => u.id == 'uni_other');
    matches.add(otherOption);
    return matches;
  }
